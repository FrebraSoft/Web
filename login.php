...
<body class="fix-header fix-sidebar">
                    ...
                    <div class="col-lg-4">
                        <div class="login-content card" style="margin-top: 50px !important;">
                            <div class="login-form">
                                <img src="./images/logo_febrasoft.png" style="width: 200px; margin-left: 50px; margin-bottom: 10px;" />
                                ...
                                <form>
                                    ...
                                    <button type="button" id="btnLogin" style="margin: 10px 0 0 0 !important; color: white;" class="btn btn-julio btn-flat m-b-30 m-t-30">Acessar</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        /** 
          ...
          * @author Marcelo Barbosa @UberHack - 02/06/2018
        */
